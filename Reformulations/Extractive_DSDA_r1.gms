...
***evaluacion de inicializacion factible
         ...
         gval("g2")=1-xvalue(iter,"x2")+xvalue(iter,"x1");
         gval("g3")=xvalue(iter,"x3")-30;
         gval("g4")=xvalue(iter,"x2")-xvalue(iter,"x3");
...
yfAz(Net)=0;
yfAz(Net)$(ord(net) eq floor((xvalue(iter,"x2"))))=1-mod((xvalue(iter,"x2")),1);
yfAz(Net)$(ord(net) eq 1+floor((xvalue(iter,"x2"))))=mod((xvalue(iter,"x2")),1);
yr(Net)$((ord(Net) ne card(Net)) and (ord(Net) ne 1))=0;
yr('2')=1;
yb(Net)$((ord(Net) ne card(Net)) and (ord(Net) ne 1))=0;
yb(Net)$(ord(Net) eq floor(xvalue(iter,"x3")))=1-mod(xvalue(iter,"x3"),1);
yb(Net)$(ord(Net) eq 1+floor(xvalue(iter,"x3")))=mod(xvalue(iter,"x3"),1);
par(Net)$((ord(Net) ne card(Net)) and (ord(Net) ne 1))=(sum(Net1$((ord(Net1) ge 2) and (ord(Net1) le ord(Net))),yr(Net1)))+(yb(Net))-(sum(Net1$((ord(Net1) ge 2) and (ord(Net1) le ord(Net))),yb(Net1)));
...
***Calculo de factibilidad de variables externas para los diferentes valors d
                 ...
                 gval("g2")=1+(xvalue(iter,"x1")+extvarhstep("x1",signo))-(xvalue(iter,"x2")+extvarhstep("x2",signo));
                 gval("g3")=-30+(xvalue(iter,"x3")+extvarhstep("x3",signo));
                 gval("g4")=(xvalue(iter,"x2")+extvarhstep("x2",signo))-(xvalue(iter,"x3")+extvarhstep("x3",signo));
...
***Calculo de valores d cuando no hay problemas de factibilidad
                                         ...
                                         yfAz(Net)=0;
                                         yfAz(Net)$(ord(net) eq floor(((xvalue(iter,"x2")+extvarhstep("x2",signo)))))=1-mod(((xvalue(iter,"x2")+extvarhstep("x2",signo))),1);
                                         yfAz(Net)$(ord(net) eq 1+floor(((xvalue(iter,"x2")+extvarhstep("x2",signo)))))=mod(((xvalue(iter,"x2")+extvarhstep("x2",signo))),1);
                                         yr(Net)$((ord(Net) ne card(Net)) and (ord(Net) ne 1))=0;
                                         yr('2')=1;
                                         yb(Net)$((ord(Net) ne card(Net)) and (ord(Net) ne 1))=0;
                                         yb(Net)$(ord(Net) eq floor((xvalue(iter,"x3")+extvarhstep("x3",signo))))=1-mod((xvalue(iter,"x3")+extvarhstep("x3",signo)),1);
                                         yb(Net)$(ord(Net) eq 1+floor((xvalue(iter,"x3")+extvarhstep("x3",signo))))=mod((xvalue(iter,"x3")+extvarhstep("x3",signo)),1);
                                         par(Net)$((ord(Net) ne card(Net)) and (ord(Net) ne 1))=(sum(Net1$((ord(Net1) ge 2) and (ord(Net1) le ord(Net))),yr(Net1)))+(yb(Net))-(sum(Net1$((ord(Net1) ge 2) and (ord(Net1) le ord(Net))),yb(Net1)));
                                         solve Extractive_DSDA_rec using nlp minimizing zobj;
...
***Calculo de valores d cuando hay problemas de factibilidad
                                         ...
                                         yfAz(Net)=0;
                                         yfAz(Net)$(ord(net) eq floor((xvalue(iter,"x2")+((extvarhstep("x2",signo))/(hstep))*(hiner1(iner1)))))=1-mod((xvalue(iter,"x2")+((extvarhstep("x2",signo))/(hstep))*(hiner1(iner1))),1);
                                         yfAz(Net)$(ord(net) eq 1+floor((xvalue(iter,"x2")+((extvarhstep("x2",signo))/(hstep))*(hiner1(iner1)))))=mod((xvalue(iter,"x2")+((extvarhstep("x2",signo))/(hstep))*(hiner1(iner1))),1);
                                         yr(Net)$((ord(Net) ne card(Net)) and (ord(Net) ne 1))=0;
                                         yr('2')=1;
                                         yb(Net)$((ord(Net) ne card(Net)) and (ord(Net) ne 1))=0;
                                         yb(Net)$(ord(net) eq floor(xvalue(iter,"x3")+((extvarhstep("x3",signo))/(hstep))*(hiner1(iner1))))=1-mod(xvalue(iter,"x3")+((extvarhstep("x3",signo))/(hstep))*(hiner1(iner1)),1);
                                         yb(Net)$(ord(net) eq 1+floor(xvalue(iter,"x3")+((extvarhstep("x3",signo))/(hstep))*(hiner1(iner1))))=mod(xvalue(iter,"x3")+((extvarhstep("x3",signo))/(hstep))*(hiner1(iner1)),1);
                                         par(Net)$((ord(Net) ne card(Net)) and (ord(Net) ne 1))=(sum(Net1$((ord(Net1) ge 2) and (ord(Net1) le ord(Net))),yr(Net1)))+(yb(Net))-(sum(Net1$((ord(Net1) ge 2) and (ord(Net1) le ord(Net))),yb(Net1)));
                                         solve Extractive_DSDA_rec using nlp minimizing zobj;
...
stop3=0;
         ...
         gval("g2")=1+(xvalue(iter,"x1")+(selectd(iter,"x1","mas")-selectd(iter,"x1","menos"))*hiner2(iner2))-(xvalue(iter,"x2")+(selectd(iter,"x2","mas")-selectd(iter,"x2","menos"))*hiner2(iner2));
         gval("g3")=(xvalue(iter,"x3")+(selectd(iter,"x3","mas")-selectd(iter,"x3","menos"))*hiner2(iner2))-30;
         gval("g4")=((xvalue(iter,"x2")+(selectd(iter,"x2","mas")-selectd(iter,"x2","menos"))*hiner2(iner2)))-(xvalue(iter,"x3")+(selectd(iter,"x3","mas")-selectd(iter,"x3","menos"))*hiner2(iner2));
...
***minimizacion en la direccion seleccionada cuando no hay problemas de convergencia
                           ...
                           yfAz(Net)=0;
                           yfAz(Net)$(ord(net) eq floor(((xvalue(iter,"x2")+(selectd(iter,"x2","mas")-selectd(iter,"x2","menos"))*hiner2(iner2)))))=1-mod(((xvalue(iter,"x2")+(selectd(iter,"x2","mas")-selectd(iter,"x2","menos"))*hiner2(iner2))),1);
                           yfAz(Net)$(ord(net) eq 1+floor(((xvalue(iter,"x2")+(selectd(iter,"x2","mas")-selectd(iter,"x2","menos"))*hiner2(iner2)))))=mod(((xvalue(iter,"x2")+(selectd(iter,"x2","mas")-selectd(iter,"x2","menos"))*hiner2(iner2))),1);
                           yr(Net)$((ord(Net) ne card(Net)) and (ord(Net) ne 1))=0;
                           yr('2')=1;
                           yb(Net)$((ord(Net) ne card(Net)) and (ord(Net) ne 1))=0;
                           yb(Net)$(ord(Net) eq floor((xvalue(iter,"x3")+(selectd(iter,"x3","mas")-selectd(iter,"x3","menos"))*hiner2(iner2))))=1-mod((xvalue(iter,"x3")+(selectd(iter,"x3","mas")-selectd(iter,"x3","menos"))*hiner2(iner2)),1);
                           yb(Net)$(ord(Net) eq 1+floor((xvalue(iter,"x3")+(selectd(iter,"x3","mas")-selectd(iter,"x3","menos"))*hiner2(iner2))))=mod((xvalue(iter,"x3")+(selectd(iter,"x3","mas")-selectd(iter,"x3","menos"))*hiner2(iner2)),1);
                           par(Net)$((ord(Net) ne card(Net)) and (ord(Net) ne 1))=(sum(Net1$((ord(Net1) ge 2) and (ord(Net1) le ord(Net))),yr(Net1)))+(yb(Net))-(sum(Net1$((ord(Net1) ge 2) and (ord(Net1) le ord(Net))),yb(Net1)));
                           solve Extractive_DSDA_rec using nlp minimizing zobj;
...
***minimizacion en la direccion seleccionada cuando hay problemas de convergencia
                           ...
                           yfAz(Net)=0;
                           yfAz(Net)$(ord(net) eq floor((xvalue(iter,"x2")+(selectd(iter,"x2","mas")-selectd(iter,"x2","menos"))*(hiner2(iner2)+hiner1(iner1)-hstep))))=1-mod((xvalue(iter,"x2")+(selectd(iter,"x2","mas")-selectd(iter,"x2","menos"))*(hiner2(iner2)+hiner1(iner1)-hstep)),1);
                           yfAz(Net)$(ord(net) eq 1+floor((xvalue(iter,"x2")+(selectd(iter,"x2","mas")-selectd(iter,"x2","menos"))*(hiner2(iner2)+hiner1(iner1)-hstep))))=mod((xvalue(iter,"x2")+(selectd(iter,"x2","mas")-selectd(iter,"x2","menos"))*(hiner2(iner2)+hiner1(iner1)-hstep)),1);
                           yr(Net)$((ord(Net) ne card(Net)) and (ord(Net) ne 1))=0;
                           yr('2')=1;
                           yb(Net)$((ord(Net) ne card(Net)) and (ord(Net) ne 1))=0;
                           yb(Net)$(ord(net) eq floor(xvalue(iter,"x3")+(selectd(iter,"x3","mas")-selectd(iter,"x3","menos"))*(hiner2(iner2)+hiner1(iner1)-hstep)))=1-mod(xvalue(iter,"x3")+(selectd(iter,"x3","mas")-selectd(iter,"x3","menos"))*(hiner2(iner2)+hiner1(iner1)-hstep),1);
                           yb(Net)$(ord(net) eq 1+floor(xvalue(iter,"x3")+(selectd(iter,"x3","mas")-selectd(iter,"x3","menos"))*(hiner2(iner2)+hiner1(iner1)-hstep)))=mod(xvalue(iter,"x3")+(selectd(iter,"x3","mas")-selectd(iter,"x3","menos"))*(hiner2(iner2)+hiner1(iner1)-hstep),1);
                           par(Net)$((ord(Net) ne card(Net)) and (ord(Net) ne 1))=(sum(Net1$((ord(Net1) ge 2) and (ord(Net1) le ord(Net))),yr(Net1)))+(yb(Net))-(sum(Net1$((ord(Net1) ge 2) and (ord(Net1) le ord(Net))),yb(Net1)));
                           solve Extractive_DSDA_rec using nlp minimizing zobj;
...
execute_unload "Tiempo_ref1.gdx",objval,CPUtime;
