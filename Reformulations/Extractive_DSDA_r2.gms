...
***evaluacion de inicializacion factible
         ...
         gval("g4")=xvalue(iter,"x1")+xvalue(iter,"x2")-xvalue(iter,"x3");
...
***Calculo de factibilidad de variables externas para los diferentes valors d
                 ...
                 gval("g4")=(xvalue(iter,"x1")+extvarhstep("x1",signo))+(xvalue(iter,"x2")+extvarhstep("x2",signo))-(xvalue(iter,"x3")+extvarhstep("x3",signo));
...
stop3=0;
         ...
         gval("g4")=((xvalue(iter,"x1")+(selectd(iter,"x1","mas")-selectd(iter,"x1","menos"))*hiner2(iner2))+(xvalue(iter,"x2")+(selectd(iter,"x2","mas")-selectd(iter,"x2","menos"))*hiner2(iner2)))-(xvalue(iter,"x3")+(selectd(iter,"x3","mas")-selectd(iter,"x3","menos"))*hiner2(iner2));
...
execute_unload "Tiempo_ref2.gdx",objval,CPUtime;
